...
import { mockBookingDetails } from '@/data/booking';

// Use centralized booking data
const bookingData = mockBookingDetails;
...
export default function BookingDetailsPage() {
  ...
  // Status Timeline Component - reused in mobile and desktop
  ...
  // Location Details Component - reused in mobile and desktop
        ...
        <div className="mt-8 space-y-6 md:hidden">
          ...
          <div className="-mx-8">
            <PhotoUploadCard
              ...
              description="Enter the name of your vehicle"
