...
export function BookingSidebar({
  ...
  return (
    <div className="rounded-lg border border-slate-200 bg-[#f9fafb]">
      {/* Vehicle Header */}
      <div className="p-6">
      ...
      {/* Breaker */}
      <div className="mx-6 h-px w-[calc(100%-48px)] bg-[#c0c4c9]" />
      ...
      <div className="p-6">
        ...
        <div className="space-y-4">
          <label className="flex items-start gap-3 cursor-pointer">
            ...
            <span className="font-manrope text-[10px] leading-[1.4] text-slate-600">
              ...
              <a href="/rental-agreement?checkbox=terms" className="font-extrabold text-slate-900 underline">
                Rental Agreement
              </a>{' '}
        ...
        <button
          type="button"
          onClick={onReserve}
          disabled={!termsAccepted || !paymentTermsAccepted}
