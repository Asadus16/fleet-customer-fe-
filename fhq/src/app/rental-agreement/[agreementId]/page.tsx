...
function RentalAgreementContent() {
  ...
  const isError = isTempAgreement ? (localDataLoaded && !localAgreementData) : apiError;
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-2 text-slate-600">The agreement you are looking for does not exist.</p>
        </div>
      </div>
    );
  }
