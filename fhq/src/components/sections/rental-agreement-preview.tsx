  ...
  return (
    <div className="text-sm text-black">
      ...
      <Section title="Insurance Information">
        <FieldRow label="Carrier Name" value={agreementData.insurance.carrierName} />
        <FieldRow label="Policy Number" value={agreementData.insurance.policyNumber} />
        <FieldRow label="Expires" value={agreementData.insurance.expires} />
        <FieldRow label="Policy Details" value={agreementData.insurance.policyDetails} />
      </Section>
