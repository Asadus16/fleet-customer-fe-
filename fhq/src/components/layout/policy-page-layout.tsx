    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto max-w-7xl mobile-section-padding py-6 md:px-8 md:py-8">
        ...
        <div className="mt-6 flex flex-col md:flex-row md:items-start md:justify-between">
          ...
          <Button variant="primary" className="mt-4 w-full gap-2.5 md:hidden">
            <Image src="/icons/download.svg" alt="Download" width={15} height={17} />
            Download PDF
          </Button>
          {/* Desktop Download Button */}
          <Button variant="primary" className="hidden shrink-0 gap-2.5 md:inline-flex">
            <Image src="/icons/download.svg" alt="Download" width={15} height={17} />
            Download PDF
          </Button>
        </div>
        ...
        <div className="mt-12 flex flex-col gap-3 md:flex-row md:justify-end md:gap-4">
          <Button variant="dark" onClick={handleCancel} className="w-full py-4 md:w-auto md:min-w-[180px] md:px-12">
            Cancel
          </Button>
          <Button variant="primary" onClick={handlePrimaryAction} className="w-full py-4 md:w-auto md:min-w-[180px] md:px-12">
            {primaryButtonLabel}
          </Button>
        </div>
      </main>
